...
export const DASHBOARD_WIDGETS = [
  { key: "hunter_status", label: "Level-Fortschritt", icon: "LV", color: "#22d3ee", desc: "XP bis zum naechsten Level", requires: null, removable: true },
  ...
  { key: "next_unlock", label: "System-Update", icon: "UPD", color: "#6366f1", desc: "Optionale Unlock-Vorschau", requires: null, removable: true },
  { key: "quick_access", label: "Schnellzugriff", icon: "GO", color: "#6366f1", desc: "Optionale Modul-Shortcuts", requires: null, removable: true },
...
const LEGACY_DENSE_DEFAULT_LAYOUT = [
  "hunter_status",
  "today_command",
  "quests",
  "streak_display",
...
export function mergeConfig(saved, can) {
  ...
  let layout = (
    ...
    || sameOrder(savedLayout, LEGACY_DENSE_DEFAULT_LAYOUT)
