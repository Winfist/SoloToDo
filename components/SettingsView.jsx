...
export const ALL_NAV_TABS = [
  { key: "dashboard",    iconSrc: "/icons/nav_dashboard.png",   label: "Heute",     desc: "Tagesübersicht & Quests" },
  { key: "training",     iconSrc: "/icons/nav_goals.png",       label: "Ziele",     desc: "Ziele, Habits & Training",   requires: "training_tab" },
  { key: "dungeon",      iconSrc: "/icons/gate_normal.png",     label: "Gates",     desc: "Dungeon Gates betreten",     requires: "dungeons", isGate: true },
  { key: "story",        iconSrc: "/icons/story_scroll.png",    label: "Story",     desc: "Deine Heldenreise",          requires: "story" },
  { key: "system",       iconSrc: "/icons/nav_settings.png",    label: "System",    desc: "Alle Module & Menüs" },
  { key: "stats",        iconSrc: "/icons/stat_str.png",        label: "Stats",     desc: "Hunter Stats & Skills",      requires: "stats_view" },
  { key: "analytics",    iconSrc: "/icons/nav_analytics.png",   label: "Analytics", desc: "Fortschritts-Auswertung",    requires: "analytics" },
  { key: "achievements", iconSrc: "/icons/nav_achievements.png",label: "Erfolge",   desc: "Meilensteine & Belohnungen", requires: "achievements" },
  { key: "challenges",   iconSrc: "/icons/nav_events.png",      label: "Events",    desc: "Challenges & Missionen",     requires: "challenges" },
  { key: "shadows",      iconSrc: "/icons/shadow_soldier.png",  label: "Schatten",  desc: "Shadow Army verwalten",      requires: "shadow_army" },
  ...
  { key: "sanctum",      iconSrc: "/icons/nav_timer.png",       label: "Sanctum",   desc: "Meditation & Willenskraft",  requires: "sanctum" },
];
