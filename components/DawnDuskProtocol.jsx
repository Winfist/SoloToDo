            ...
            <>
                ...
                {["dawn", "dusk"].map(type => {
                  ...
                  return (
                    <button key={type} onClick={() => setTab(type)} style={{
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>{type === "dawn" ? <img src="/icons/story_dawn.webp" alt="Dawn" style={{ width: 28, height: 28, objectFit: "contain", filter: "drop-shadow(0 0 6px #fbbf2488) brightness(1.1)" }} /> : <img src="/icons/health_sleep.webp" alt="Dusk" style={{ width: 28, height: 28, objectFit: "contain", filter: "drop-shadow(0 0 6px #818cf888) brightness(1.1)" }} />}</div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    letterSpacing: "0.12em"
                     ...
                     <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>{tab === "dawn" ? <img src="/icons/story_dawn.webp" alt="" style={{ width: 14, height: 14, objectFit: "contain" }} /> : <img src="/icons/health_sleep.webp" alt="" style={{ width: 14, height: 14, objectFit: "contain" }} />} {tab === "dawn" ? "MORGEN-ETAGEN" : "ABEND-ETAGEN"}</span>
                ...
                {currentTasks.length === 0 ? (
                  <div style={{
                    ...
                    background: `${tabColor}05`
                     ...
                     <div style={{ marginBottom: "0.5rem" }}><img src={tab === "dawn" ? "/icons/story_dawn.webp" : "/icons/health_sleep.webp"} alt="" style={{ width: 36, height: 36, objectFit: "contain", filter: `drop-shadow(0 0 8px ${tabColor}88) brightness(1.1)` }} /></div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                {currentTasks.length > 0 && windowOpen && (
                  ...
                  >
                     <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>{tab === "dawn" ? <img src="/icons/story_dawn.webp" alt="" style={{ width: 18, height: 18, objectFit: "contain" }} /> : <img src="/icons/health_sleep.webp" alt="" style={{ width: 18, height: 18, objectFit: "contain" }} />} {tab === "dawn" ? "DAWN PROTOCOL STARTEN" : "DUSK PROTOCOL STARTEN"}</span>
                  </button>
                )}
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1rem"
                   ...
                   {tab === "dawn" ? <img src="/icons/story_dawn.webp" alt="Dawn" style={{ width: 20, height: 20, objectFit: "contain", filter: `drop-shadow(0 0 4px ${tabColor}88)` }} /> : <img src="/icons/health_sleep.webp" alt="Dusk" style={{ width: 20, height: 20, objectFit: "contain", filter: `drop-shadow(0 0 4px ${tabColor}88)` }} />}
                </div>
                <div>
