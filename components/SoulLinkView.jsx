...
import { NAV_ICONS, STAT_ICONS, QUEST_ICONS } from "../data/icons";
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem", marginBottom: "1rem" }}>
              ...
              <div style={{
                ...
                <div style={{ color: "#6b7280", fontSize: "0.65rem", marginTop: "0.25rem" }}>
                  {state.lastActiveDate === today ? <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}><img src={QUEST_ICONS.daily} alt="" style={{ width: 10, height: 10, objectFit: "contain" }} /> Heute aktiv</span> : "Noch inaktiv"}
                </div>
              </div>
              ...
              <div style={{
                ...
                {soulLink.partnerName ? (
                  <>
                    ...
                    <div style={{ color: "#6b7280", fontSize: "0.65rem", marginTop: "0.25rem" }}>
                      {soulLink.partnerLastActive === today ? <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}><img src={QUEST_ICONS.daily} alt="" style={{ width: 10, height: 10, objectFit: "contain" }} /> Heute aktiv</span> : "Noch inaktiv"}
                    </div>
                  </>
                ) : (
