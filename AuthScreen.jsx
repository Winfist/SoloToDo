...
@keyframes inputFocus { 0% { background-position: 0% 50%; } 100% { background-position: 200% 50%; } }
@keyframes runeRotate { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
@keyframes runeFloat { 0%, 100% { transform: translateY(0) rotate(var(--rot)); opacity: 0.3; } 50% { transform: translateY(-20px) rotate(var(--rot)); opacity: 0.7; } }
@keyframes particleRise { 0% { transform: translateY(100vh) scale(0); opacity: 0; } 10% { opacity: 1; } 90% { opacity: 1; } 100% { transform: translateY(-100px) scale(1); opacity: 0; } }
@keyframes swordSwing { 0% { transform: rotate(-30deg) scale(0.8); opacity: 0; } 50% { transform: rotate(10deg) scale(1.1); opacity: 1; } 100% { transform: rotate(0deg) scale(1); opacity: 1; } }
@keyframes crackSpread { 0% { clip-path: inset(50% 50% 50% 50%); opacity: 0; } 100% { clip-path: inset(0% 0% 0% 0%); opacity: 1; } }
...
function ParticleField() {
  ...
  useEffect(() => {
    ...
    const particles = Array.from({ length: 60 }, () => ({
      ...
      hue: Math.random() * 60 + 250, // Purple range
    }));
    ...
    const draw = () => {
      ...
      floatingRunes.forEach(r => {
        ...
        if (r.y < -50) {
          ...
          r.rune = runes[Math.floor(Math.random() * runes.length)];
        }
      });
  ...
  return (
    <div style={{
      ...
      <div style={{
        position: "absolute",
        inset: 0,
        background: "radial-gradient(ellipse at 50% 0%, #1a0a2e 0%, #0a0612 50%, #060410 100%)",
      }} />
      ...
      <div style={{
        ...
        width: "60%",
        height: "60%",
        background: "radial-gradient(circle, #4f46e515 0%, transparent 70%)",
      ...
      <div style={{
        ...
        width: "30%",
        height: "30%",
        background: "radial-gradient(circle, #a78bfa10 0%, transparent 70%)",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: "50%",
        animation: "runeRotate 40s linear infinite reverse",
      }}>
      ...
      <div style={{
        ...
        borderRadius: "50%",
        animation: "runeRotate 25s linear infinite",
        background: active 
          ? "radial-gradient(circle, #7c3aed08 0%, transparent 70%)" 
          : "transparent",
...
function AuthButton({ children, onClick, loading, disabled, variant = "primary", delay = 0 }) {
  ...
  return (
    <button
      ...
      style={{
        width: "100%",
        padding: isPrimary ? "18px 24px" : "14px 24px",
        borderRadius: 14,
        ...
        boxShadow: isPrimary && hover && !disabled
          ? "0 10px 40px rgba(124, 58, 237, 0.4), 0 0 80px rgba(124, 58, 237, 0.2)"
          : isPrimary 
      ...
      {loading ? (
        <div style={{
          ...
          <div style={{
            ...
            borderTopColor: "#fff",
            borderRadius: "50%",
            animation: "runeRotate 0.8s linear infinite",
          }} />
      ...
      <div style={{
        ...
        {[1, 2, 3, 4].map(level => (
          <div key={level} style={{
            ...
            height: 3,
            borderRadius: 2,
            background: level <= strength.level ? strength.color : "#1e1e3f",
            transition: "all 0.3s ease",
          }} />
        ))}
      </div>
    ...
    <div style={{
      ...
      {phase >= 1 && (
        <div style={{
          ...
          animation: "portalOpen 1s cubic-bezier(0.34, 1.56, 0.64, 1)",
          boxShadow: "0 0 60px #7c3aed44, inset 0 0 60px #7c3aed22",
        }} />
      )}
      ...
      {phase >= 2 && (
        <div style={{
          position: "absolute",
          width: 4,
          background: "linear-gradient(to top, transparent, #7c3aed, #a78bfa, transparent)",
      ...
      {phase >= 5 && (
        <div style={{
          ...
          {[
            { stat: "STR", val: 0, color: "#ef4444" },
            { stat: "INT", val: 0, color: "#3b82f6" },
            { stat: "VIT", val: 0, color: "#22c55e" },
            { stat: "AGI", val: 0, color: "#f59e0b" },
            { stat: "CHA", val: 0, color: "#a855f7" },
          ].map((s, i) => (
            <div key={s.stat} style={{
              textAlign: "center",
              animation: `statsReveal 0.4s ease ${i * 0.1}s both`,
            }}>
              <div style={{
                fontSize: 10,
                color: s.color,
...
export default function AuthScreen({ onAuthSuccess }) {
  ...
  const validate = () => {
    ...
    if (mode === "register") {
      if (!hunterName) {
        newErrors.hunterName = "Hunter-Name erforderlich";
      } else if (hunterName.length < 3) {
        newErrors.hunterName = "Mindestens 3 Zeichen";
      }
      ...
      if (!agreedToTerms) {
        newErrors.terms = "Bitte akzeptiere die Bedingungen";
      }
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (error.code === "auth/user-not-found" || error.code === "auth/wrong-password" || error.code === "auth/invalid-credential") {
        newErrors.email = "E-Mail oder Passwort falsch";
        newErrors.password = " ";
      } else if (error.code === "auth/email-already-in-use") {
        newErrors.email = "E-Mail wird bereits verwendet";
      } else if (error.code === "auth/weak-password") {
        newErrors.password = "Passwort ist zu schwach";
      } else {
        newErrors.email = "Ein Systemfehler ist aufgetreten: " + error.message;
      }
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setErrors({ email: "Google Login fehlgeschlagen" });
    } finally {
      setLoading(false);
    }
  };
  ...
  if (showSuccess) {
    return (
      <SuccessAnimation 
        ...
        onComplete={() => onAuthSuccess(hunterName || "Hunter")} 
      />
    );
  }
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            letterSpacing: 8,
            marginBottom: 8,
            animation: "textGlow 3s ease-in-out infinite, slideDown 0.8s ease",
          }}>
            ARISE
          </h1>
        ...
        <div style={{
          ...
          animation: "scaleIn 0.6s ease, borderGlow 4s ease-in-out infinite",
        }}>
            ...
            <div style={{
              ...
              <label style={{
                ...
                <div style={{
                  ...
                  height: 20,
                  borderRadius: 6,
                  border: `2px solid ${errors.terms ? "#ef4444" : agreedToTerms ? "#7c3aed" : "#1e1e3f"}`,
                  background: agreedToTerms ? "#7c3aed" : "transparent",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  transition: "all 0.3s ease",
